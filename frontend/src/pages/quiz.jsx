...
// import { getQuestion, setResult, getUser } from "../utils/fetch";
...
//     } else {
//       const incorrectAnswer = question.length - correctAnswer;
//       try {
...
//       } catch (error) {
//         console.error("Error set result:", error);
//       }
//     }
//   };
//   return (
// <div className="flex items-center justify-center min-h-screen bg-gray-100 ">
//   <div className="bg-gray-300 text-gray-800 min-w-screen rounded-lg mx-24 ">
